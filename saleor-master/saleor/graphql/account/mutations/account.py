...
class AccountSocialRegisterInput(graphene.InputObjectType):
    email = graphene.String(description="The email address of the user.", required=True)
    socialId = graphene.String(description="social register id.")
    socialType = graphene.String(description="social type.")
